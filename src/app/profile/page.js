...
export default function ProfilePage() {
    ...
    // 🚀 Buka UI secepat mungkin! Hanya tampilkan skeleton jika Auth benar-benar belum siap
    if (authLoading && !user) {
        return (
            <div className="flex min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
                <Sidebar />
                <main className="flex-1 p-4 sm:p-6 md:p-8 max-w-4xl w-full animate-pulse space-y-6">
