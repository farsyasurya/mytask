                ...
                <div className="grid grid-cols-7 gap-2 min-w-[600px]">
                    ...
                    {Array.from({ length: daysInMonth }).map((_, i) => {
                        ...
                        return (
                            <div
                                key={day}
                                className={`h-28 sm:h-32 border rounded-xl p-2 flex flex-col justify-between transition-all duration-200 hover:border-indigo-300 dark:hover:border-indigo-700 ${
                                    currentDayIsToday
